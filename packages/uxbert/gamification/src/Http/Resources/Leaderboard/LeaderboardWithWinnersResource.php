...
use Uxbert\Gamification\Http\Resources\Reward\RewardWithWinnersResource;
use Uxbert\Gamification\Models\Reward;
use Uxbert\Gamification\Models\Client_User;


class LeaderboardWithWinnersResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        if(!empty($this->rewards)) {
            ...
            foreach($rewards as $value){
                ...
                $rewardsJsonArray[] = array('reward' => new RewardWithWinnersResource($reward, $this->id), 'rank' => $value->rank);
            }
