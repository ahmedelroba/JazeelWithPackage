@extends('layouts.app')
@section('title', 'Server IP List Management')
...
<a href="{{ route('integration_system.ip_list.create') }}" class="btn btn-round  edit btn-primary">{{ trans('backend.create_new_ip') }}</a>
@endsection
    ...
    var KTDatatablesExtensionButtons = function() {
        ...
        var initTable1 = function() {
            ...
            var table = $('#kt_table_1').DataTable({
                ...
                ajax: {
                    url: '{!! route('integration_system.ip_list.get_ajax_roles') !!}',
                    type: 'GET',
                    data: {
