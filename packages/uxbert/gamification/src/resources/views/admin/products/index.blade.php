...
<a href="{{ route('integration_system.products.create') }}" class="btn btn-round  edit btn-primary">{{ trans('backend.create_new_product') }}</a>
@endsection
    ...
    var KTDatatablesExtensionButtons = function() {
        ...
        var initTable1 = function() {
            ...
            var table = $('#kt_table_1').DataTable({
                ...
                ajax: {
                    url: '{!! route('integration_system.products.get_ajax_roles') !!}',
                    type: 'GET',
                    data: {
