...
<a href="{{ route('roles.create') }}" class="btn btn-round  edit btn-primary">{{ trans('backend.create_new_role') }}</a>
@endsection
    ...
    var KTDatatablesExtensionButtons = function() {
        ...
        var initTable1 = function() {
            ...
            var table = $('#kt_table_1').DataTable({
                ...
                ajax: {
                    url: '{!! route('roles.get_ajax_roles') !!}',
                    type: 'GET',
                    data: {
...
<script>
        ...
        Swal.fire({
            title: "{{trans('backend.ask_for_delete_message')}}",
            type: "warning",
            buttons: true,
