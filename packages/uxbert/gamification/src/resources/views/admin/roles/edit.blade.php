@extends('layouts.app')
@section('title', trans('backend.update_role'))
@section('content-container')
{!! Form::model($role, ['method' => 'PATCH','route' => ['roles.update', $role->name]]) !!}

<div class="form-group row">
    <label for="example-text-input" class="col-2 col-form-label">{{ trans('backend.name') }}</label>
    <div class="col-10">
        {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Enter Role name', 'required' => 'required']) !!}
    </div>
</div>
